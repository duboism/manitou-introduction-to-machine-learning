...
\begin{frame}
  ...
  \begin{textblock}{90}(05,15)
    ...
    \item<3-> \acf{ML}:
      ...
      \item<4-> ``A computer program is said to learn from experience
...
\begin{frame}
  ...
  \begin{textblock}{45}(05,45)
    \begin{itemize}
    \item<2-> Birth of \acl{AI} and \acl{ML}:
      \begin{itemize}
      \item Dartmouth workshop (1956)
      \item Development of many approaches and
        techniques (including \acs{NN})
      \end{itemize}
    \item<3-> ``Winters'' of \ac{AI}
      \begin{itemize}
  ...
  \begin{textblock}{45}(50,45)
    \begin{itemize}
    \item<4-> Rise of \ac{ML} at the turn of the millennium
      \begin{itemize}
      \item Built on work of previous decades
      \item Lots of data, processing and storage capability, mature technology
      \end{itemize}
    \item<5-> Rise of \acl{DL} since 2012
      \begin{itemize}
      \item AlexNet (2012): first \ac{DL} model to out-performs classical
        methods
      \end{itemize}
    \end{itemize}
  \end{textblock}
