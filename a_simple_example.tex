  ...
  \begin{textblock}{45}(50, 55)
    \onslide<4->{
      ...
      \item<5-> We must compute
        $\apply{\grad_{\params}\lossFunc}{\params_{t}}$ \hyperlink{Backpropagation}{\beamergotobutton{Details}}
      \item<6-> Back-propagation is an efficient method for that in feed-forward architectures
